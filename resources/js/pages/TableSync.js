...
export default function TableSync() {
  return <Layoutv2 title="Table Sync" component={component} />;
}
...
function component() {
  ...
  return (
    <Row>
      ...
      <Modal {...modalAttr()} title="Table Sync Form" large={true} bindAction={() => bindCreateUpdateButtonModal({ textCreate: "Add", textUpdate: "Save" })}>
        ...
        <div className="col-md-6">
          <div className="form-group">
            ...
            <input className="form-control" {...bindInput("tracker_name")} />
          </div>
        </div>

        <div className="col-md-6">
          <div className="form-group">
            <label>Tracker Reset Value</label>
            <input className="form-control" {...bindInput("tracker_reset_value")} />
          </div>
        </div>
        ...
        <div className="col-md-6">
          <div className="form-group">
            ...
            <input className="form-control" {...bindInput("chunk_size")} />
          </div>
        </div>
