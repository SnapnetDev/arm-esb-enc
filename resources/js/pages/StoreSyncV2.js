...
export default function StoreSyncV2() {
  // const result = useCrud({ resource: "store-sync" });
  return (
<Layoutv3 title="Store Sync">
    <Resource.Container baseapi={API_PATH} resource="store-sync">
      ...
      {/* width={"w-9/12"} */}
     <Resource.CreateModal title="Create Store Sync" height="max-h-full">

     <div className="space-y-4">
        <div className="flex flex-col justify-start gap-4">
          <Resource.Input label="Store Sync Name" source="name" />
    ...
    <div className="mr-2 overflow-x-scroll">
      <div className="flex mt-2 justify-between items-center">
        <h5 className="text-base sm:text-xl">Store Sync</h5>
        <Resource.AddButton>
          Add Store Sync
        </Resource.AddButton>
      </div>
