...
export const TableSyncCard = ({ data, status, syncLink }) => {
  return (
    <div className=" container mx-0 bg-white space-y-2 p-4 max-w-sm rounded-lg">
      <h6 className="text-base md:text-lg">Sync Account Store To Table</h6>
      <p className="text-xs md:text-sm">
        {data.api.category.name} From {data.table_object.name}
      </p>
